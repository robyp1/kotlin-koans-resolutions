...
fun finder (cityCustomer : City, cityExpected : City) : Boolean{
    val cityMatch: (City) -> Boolean = { it == cityExpected }
    return cityMatch(cityCustomer)
}

fun Customer.isFrom(city: City): Boolean {
    // Return true if the customer is from the given city
    //return this.city == city oppure:
    return finder(this.city, city)
    //todoCollectionTask()
